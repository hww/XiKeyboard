...
{
	public class DMUInt16 : TDMMenuValue<UInt16>
	{
		#region Public Vars
		...
		public DMUInt16(string text, Func<UInt16> getter, Action<UInt16> setter = null, string shortcut = null, string help = null)
